...
CONTENT_REPO="${1:?Usage: $0 <repo_url> <branch> <output_dir>}"
CONTENT_BRANCH="${2:?Usage: $0 <repo_url> <branch> <output_dir>}"
OUTPUT_DIR="${3:?Usage: $0 <repo_url> <branch> <output_dir>}"
BUILD_DIR="${4:-/build}"
...
cd "${BUILD_DIR}" && pixi install --frozen
